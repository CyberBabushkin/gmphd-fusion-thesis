...
\input{text/summary}
\chapter{List of Acronyms}\input{text/acronyms}
...
\chapter*{Introduction}
    \input{text/introduction/index}
    \section*{Motivation}
        \input{text/introduction/motivation}
    \section*{Related works}
        \input{text/introduction/related-works}
    \section*{Contribution of this work}
        \input{text/introduction/contribution}
    \section*{Structure}
        \input{text/introduction/structure}
...
\chapter{Appendix 1. Results comparison across different filter parameters}\label{appendix:results-figures}
    \input{text/appendices/results-figures}
...
\chapter{Contents of the attached medium}\input{text/medium}
