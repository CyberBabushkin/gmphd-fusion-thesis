...
% Test scenarios, data generation
% Implementation
%     - Mention the covariance normalization 
% Results
%    - Clutter
%    - P_D
%    - P_S
%    - \tau
% Fusion vs. non-fusion table
