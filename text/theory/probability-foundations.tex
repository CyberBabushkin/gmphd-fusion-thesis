...
parameter $x$ means ``evaluated at.'' It should be noted that if the mean is a 
vector, denoted as $\mathbf{\mu}$, the variance becomes a matrix, written as 
$\Sigma$, and the overall distribution is, therefore, denoted as 
